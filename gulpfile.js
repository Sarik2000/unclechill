...
const {sprite, spriteLang} = require('./gulp/task/sprite');
...
const dev = series(favicon, font, sprite, spriteLang, styles, script, json, vendors, images, html);
const minify = series(favicon, font, sprite, spriteLang, stylesBuild, script, json, vendors, images, htmlBuild);
